window.onload = function(){
	...
	$.ajax({
		...
		success:function(data){
			if(data==true){
				$("#navigations").append("<li><a href=\"segmentadd.html\">Add a segment</a></li>");
